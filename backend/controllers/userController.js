...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const link = `${process.env.CLIENT_API_BASE_URL}/users/${user._id}/verify/${token.token}`;
...
const forgotPassword = asyncHandler(async (req, res, next) => {
  ...
  const content = `${process.env.CLIENT_API_BASE_URL}/resetpassword/${user._id}/${token.token}`;
